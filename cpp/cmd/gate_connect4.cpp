...
int main(int argc, const char** argv) {
  ...
  evaluator[0] = new QueuedLibtorchEvaluator(model_left, Connect4::CANONICAL_SHAPE,
                                             /*use_cpu_only=*/false);
  evaluator[1] = new QueuedLibtorchEvaluator(model_right, Connect4::CANONICAL_SHAPE,
                                             /*use_cpu_only=*/false,
